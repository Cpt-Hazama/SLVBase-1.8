...
function SWEP:Deploy()
	if SERVER then self:PlaySound("Deploy") end
...
function SWEP:Holster(wep)
	if ValidEntity(self.clMdl) then self.clMdl:Remove() end
	self.lastAttack = nil
